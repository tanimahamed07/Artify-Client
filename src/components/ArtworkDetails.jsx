...
const ArtworkDetails = () => {
  ...
  const handleFevorites = () => {
    ...
    axiosInstance.post("/fevorites", { userEmail: user.email, ...favorite })
      .then((res) => {
            ...
            <Fade direction="up" cascade triggerOnce damping={0.1}>
              <div className="space-y-4">
                ...
                <p className="text-lg md:text-xl text-neutral/70 italic border-l-4 border-primary pl-6 py-1">
                  Crafted by <span className="text-neutral font-black">{details?.artistName}</span>
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-base-200/50 p-4 rounded-2xl border border-base-200">
                  ...
                  <p className="font-bold text-lg text-secondary">${details?.price || "Negotiable"}</p>
                </div>
              </div>

              <div className="space-y-2">
                <h3 className="text-xs font-black uppercase tracking-[0.2em] text-neutral/40">Description</h3>
                <p className="text-neutral/70 leading-relaxed text-lg italic">
                  "{details?.description}"
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-6">
                ...
                <button
                  ...
                  className="btn btn-secondary btn-lg rounded-2xl gap-3 px-8 shadow-xl shadow-secondary/20 hover:scale-105 transition-transform text-white"
                >
                  <FaHeart size={20} />
                  Add to Favorites
                </button>
