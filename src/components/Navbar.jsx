...
const Navbar = () => {
  ...
  return (
    <div className={`sticky top-0 z-[100] w-full transition-all duration-300 ${
      scrolled ? "bg-base-100/70 backdrop-blur-xl border-b border-base-200 shadow-sm py-1" : "bg-transparent py-3"
    }`}>
      <div className="navbar container mx-auto px-4">
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-4 shadow-2xl bg-base-100 rounded-2xl w-64 border border-base-200 space-y-2">
          ...
          <Link to="/" className="flex items-center gap-2 group transition-transform active:scale-95">
            <div className="bg-primary/10 p-1.5 rounded-xl group-hover:bg-primary/20 transition-colors">
              <img className="w-8 md:w-10 group-hover:scale-110 transition-transform duration-500" src={logo} alt="Artify Logo" />
            </div>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="flex items-center gap-4">
            ...
            {user && (
              <>
                <li><NavLink className={navLinkStyles} to="/add-artworks">Add Art</NavLink></li>
                <li><NavLink className={navLinkStyles} to="/my-gallary">Gallery</NavLink></li>
        ...
        <div className="navbar-end flex items-center gap-3">
          ...
          {user ? (
            <div className="dropdown dropdown-end dropdown-hover">
              <div tabIndex={0} role="button" className="avatar transition-all duration-300 hover:scale-110">
                <div className="w-10 md:w-11 rounded-full ring ring-primary/30 ring-offset-base-100 ring-offset-2 overflow-hidden shadow-lg">
                  <img src={user.photoURL || "https://i.ibb.co/mJR7z8f/user.png"} alt="User" />
                </div>
              </div>
              <ul tabIndex={0} className="mt-2 z-[1] p-3 shadow-2xl menu menu-sm dropdown-content bg-base-100 rounded-2xl w-56 border border-base-200 animate-in fade-in zoom-in duration-200">
                ...
                <li><Link to="/dashboard" className="hover:text-primary">Dashboard Home</Link></li>
                <li><Link to="/profile" className="hover:text-primary">View Profile</Link></li>
                <div className="divider my-1"></div>
                <li>
                  <button onClick={handleSignOut} className="btn btn-error btn-sm btn-outline rounded-xl hover:text-white transition-all">
                    Sign Out
                  </button>
                </li>
              </ul>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/register" className="btn btn-primary btn-sm md:btn-md rounded-full px-5 shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300">
                Get Started
              </Link>
            </div>
          )}
