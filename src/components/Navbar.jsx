  ...
  return (
    <div
      className={`sticky top-0 z-[100] w-full transition-all duration-300 ${
        scrolled
          ? "bg-base-100/70 backdrop-blur-xl border-b border-base-200 shadow-sm py-1"
          : "bg-transparent py-3"
      }`}
    >
          ...
          <div className="dropdown">
            ...
            >
              ...
              {user && (
                <>
                  <li>
                    <NavLink to="/add-artworks">Add Artworks</NavLink>
                  </li>
                  <li>
          ...
          {user ? (
            <div className="dropdown dropdown-end dropdown-hover">
              <div
                tabIndex={0}
                role="button"
                className="avatar transition-all duration-300 hover:scale-110"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/register"
                className="btn btn-primary btn-sm md:btn-md rounded-full px-5 shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300"
              >
                Get Started
              </Link>
            </div>
